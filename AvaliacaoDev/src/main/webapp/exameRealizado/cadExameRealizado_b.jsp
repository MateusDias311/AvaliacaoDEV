		...
		<div class="container">
			<div class="row mt-5 mb-2">
				<div class="col-sm p-0">
					<s:form action="/filtrarExameRealizados.action">
					...
					<tbody>
						<s:iterator value="funcionarios" >
							<tr>
								...
								<td>${nome}</td>
								<td class="text-end">
									<s:url action="editarExameRealizados" var="editar">
										<s:param name="exameRealizadoVo.rowid" value="rowid"></s:param>
									</s:url>

									<a href="${editar}" class="btn btn-warning text-white">
										<s:text name="label.incluirExame"/>
									</a>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
				...
				<s:a id="excluir" class="btn btn-primary" style="width: 75px;" action = "excluirExameRealizados">
					<s:param name="exameRealizadoVo.rowid" value="rowid"></s:param>
